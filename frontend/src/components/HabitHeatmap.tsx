...
const HabitHeatmap: React.FC<HabitHeatmapProps> = ({
  ...
  return (
    <>
      <div
        className={`bg-gradient-to-br from-gray-800/50 to-gray-900/50 rounded-2xl p-4 sm:p-6 border border-gray-700/30 backdrop-blur-sm relative ${
          isOptimistic ? "opacity-75" : ""
        }`}
      >
        {/* Optimistic update indicator */}
        {isOptimistic && (
          <div className="absolute top-4 right-4 flex items-center gap-2 bg-blue-500/20 px-2 py-1 rounded-full">
          ...
          <div className="flex flex-wrap items-center gap-3 sm:gap-4">
            ...
            <AnimatePresence mode="wait">
              <motion.div
                ...
                className="flex items-center gap-2 bg-orange-500/10 px-2 sm:px-3 py-1.5 rounded-lg"
              >
            ...
            <button
              ...
              className="p-1.5 sm:p-2 text-gray-400 hover:text-red-400 hover:bg-red-900/20 rounded-lg transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
              title="Delete habit"
            >
              <Trash2 size={18} />
            </button>
              ...
              {Array.from({ length: 7 }, (_, rowIndex) => {
                ...
                return (
                  <button
                    ...
                    disabled={isFuture || isPast || isOptimistic}
                    className={`
        ...
        <div className="flex justify-center">
          <button
            ...
            disabled={isOptimistic}
            className="group relative px-6 py-3 bg-gradient-to-r from-green-600 to-emerald-600 rounded-xl font-medium transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-green-500/25 focus:outline-none focus:ring-4 focus:ring-green-500/50 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
